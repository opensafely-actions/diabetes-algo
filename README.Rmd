...
-   t2dm_date: First date from T1DM clinical, T2DM clinical, and diabetes medication codes
-   t1dm_date: First date from T1DM clinical, T2DM clinical, and diabetes medication (without T2DM-specific medication) codes
-   otherdm_date: First date from T1DM clinical, T2DM clinical, diabetes medication, diabetes-specific process, and diabetes-unspecific clinical codes
