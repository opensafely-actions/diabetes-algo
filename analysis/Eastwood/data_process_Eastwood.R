...
source(here::here(
  ...
  "Eastwood",
  "functions",
  "fn_diabetes_algorithm.R"
))

# check if output sub directory exists, create if not
fs::dir_create(here::here("output/Eastwood"))
...
option_list <- list(
  ...
  make_option(
    ...
    type = "character",
    default = "tmp_t1dm_primarycare_date",
  ...
  make_option(
    ...
    type = "character",
    default = "tmp_t2dm_primarycare_date",
  ...
  make_option(
    "--tmp_otherdm_count_num",
    type = "character",
    default = "tmp_otherdm_count_num",
  ...
  make_option(
    ...
    type = "character",
    default = "tmp_poccdm_primarycare_count_num",
  ...
  make_option(
    "--tmp_max_hba1c_mmol_mol_num",
    type = "character",
    default = "tmp_max_hba1c_mmol_mol_num",
  ...
  make_option(
    "--tmp_max_hba1c_date",
    type = "character",
    default = "tmp_max_hba1c_date",
    help = "First maximum HbA1c value date, from primary care only [default %default]",
    metavar = "YYYY-MM-DD"
  ),
  make_option(
    "--tmp_insulin_dmd_date",
    type = "character",
    default = "tmp_insulin_dmd_date",
  ...
  make_option(
    "--tmp_antidiabetic_drugs_dmd_date",
    type = "character",
    default = "tmp_antidiabetic_drugs_dmd_date",
  ...
  make_option(
    "--tmp_nonmetform_drugs_dmd_date",
    type = "character",
    default = "tmp_nonmetform_drugs_dmd_date",
  ...
  make_option(
    ...
    type = "character",
    default = "tmp_diabetes_medication_date",
  ...
  make_option(
    ...
    type = "character",
    default = "tmp_first_diabetes_diag_date",
...
invalid_ethnicity <- core$ethnicity_cat[
  is.na(core$ethnicity_cat) |
...
print(
  "'ethnicity_cat' validation passed: all values are valid categories (NA not allowed)."
)
...
################################################################################
print("Save output")
write_rds(data_processed, paste0("output/Eastwood/", opt$df_output))
write_csv(
  data_processed,
  here::here("output/Eastwood", paste0(opt$df_output)),
  na = ""
) # important to specify (na = ""), otherwise @table_from_file("output/Eastwood/data_processed.csv.gz") doesn't work (accepts empty or a date, but not NA)
