...
- Besides the categorical type variable, it provides the diagnosis date for each type as follows:
-   gestationaldm_date: Based only on dates from GDM clinical codes
-   t2dm_date: Minimum date from T1DM, T2DM, and diabetes medication codes
-   t1dm_date: Minimum date from T1DM, T2DM, and diabetes medication (without T2DM-specific medication) codes
-   otherdm_date: Minimum date from T1DM, T2DM, diabetes medication, diabetes-specific process codes, and diabetes-unspecific clinical codes
